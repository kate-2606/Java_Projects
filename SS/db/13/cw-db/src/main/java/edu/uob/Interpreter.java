...
public class Interpreter {
    ...
    private Table readTableFile(String tableName) throws IOException, InterpreterException {
    ...
    public Table findTable(String tableName) throws InterpreterException, IOException {
    ...
    public void joinCommand() throws InterpreterException, IOException {
    ...
    public void selectCommand() throws InterpreterException, IOException {
        if(debugging){
            System.out.println("in command select");
        }
