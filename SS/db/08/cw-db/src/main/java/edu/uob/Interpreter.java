...
public class Interpreter {
        ...
        if(ic.getDatabasePath()!=null && !ic.getWorkingDatabase().tableExists(tableName)) {
            ...
            if (!(fileToOpen.isDirectory()) && fileToOpen.exists()) {
                ...
                try {
                    ...
                    System.out.println("line is: "+line + "  table: "+tableName);
                    System.out.println(ic.getDatabasePath());
    ...
    private boolean checkAttributeName(String attributeName, String tableName) throws InterpreterException {
        if(attributeName.contains(".")) {
            ...
            if (!tableName.equals(names[0])) {
                throw new InterpreterException.FoundInvalidAttributeName(attributeName);
            }
        }
        return true;
    }
    ...
    private HashSet<Long> baseConditionCommand(Table table) throws InterpreterException {
        ...
        System.out.println("attribute " + columnStr);
    ...
    //private void conditionWithEquals()
