...
public class InterpreterTests {
    ...
    @Test
    public void testBasicCreateAndCommand1() throws InterpreterException {
    ...
    @Test
    public void testBasicSelectCommand() {
    ...
    public void testNestedSelectCommand() {
        ...
        String response = sendCommandToServer("SELECT * FROM details WHERE (email LIKE 'hotmail' AND hairColour=='brown') OR hair=='silver';");
        sendCommandToServer("DROP DATABASE details;");
    }
